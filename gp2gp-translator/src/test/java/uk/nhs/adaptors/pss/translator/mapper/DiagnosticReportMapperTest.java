...
public class DiagnosticReportMapperTest {
    ...
    private final Patient PATIENT = (Patient) new Patient().setId("PATIENT_TEST_ID");
    ...
    public void testRelatedObservationsMapping() {
        ...
        var diagnosticReports = diagnosticReportMapper.mapDiagnosticReports(ehrExtract, PATIENT, List.of(), PRACTISE_CODE);
        var specimen = diagnosticReportMapper.mapSpecimen(ehrExtract, diagnosticReports, PATIENT, PRACTISE_CODE);
        assertThat(diagnosticReports).isNotEmpty();
    }
