...
export SNOWED_FILE_LOCATION="/Users/scott.alexander/Documents/projects/nhs-d/uk_sct2cl_32.10.0_20220216000001Z.zip";
...
export STORAGE_REGION="UK South";
export STORAGE_CONTAINER_NAME="nhsdfilestore";
export STORAGE_REFERENCE="nhspatientadapter";
export STORAGE_SECRET="DXuroQ2xmhdPcU9S7BYHZGciLGgKjWF8yjDqjRJTV4/QjJUUU45rRoeNFv6ICDcfBtr04oUDts8b+AStpAyEOw==";
