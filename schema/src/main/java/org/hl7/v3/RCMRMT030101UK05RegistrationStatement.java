...
@XmlType(name = "RCMR_MT030101UK05.RegistrationStatement", propOrder = {
    "id",
    "code",
    "statusCode",
    "effectiveTime",
...
public class RCMRMT030101UK05RegistrationStatement implements RCMRMT030101UKRegistrationStatement {
    ...
    @XmlElement(type = RCMRMT030101UK05ResponsibleParty2.class)
