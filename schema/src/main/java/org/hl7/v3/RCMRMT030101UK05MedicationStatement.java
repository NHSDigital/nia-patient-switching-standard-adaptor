...
@XmlType(name = "RCMR_MT030101UK05.MedicationStatement", propOrder = {
    "id",
    "statusCode",
    "effectiveTime",
    "availabilityTime",
...
public class RCMRMT030101UK05MedicationStatement implements RCMRMT030101UKMedicationStatement {
    ...
    @XmlElement(type = RCMRMT030101UK05Consumable.class)
    protected List<RCMRMT030101UKConsumable> consumable;

    @XmlElement(type = RCMRMT030101UK05Component2.class)
    protected List<RCMRMT030101UKComponent2> component;

    @XmlElement(type = RCMRMT030101UK05PertinentInformation.class)
