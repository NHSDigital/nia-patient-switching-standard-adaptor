...
@XmlType(name = "RCMR_MT030101UK05.EhrComposition", propOrder = {
    "id",
    "code",
    "statusCode",
    "effectiveTime",
...
public class RCMRMT030101UK05EhrComposition implements RCMRMT030101UKEhrComposition {
    ...
    @XmlElement(required = true, type = RCMRMT030101UK05Author.class)
    ...
    @XmlElement(name = "Participant2", type = RCMRMT030101UK05Participant2.class)
    protected List<RCMRMT030101UKParticipant2> participant2;

    @XmlElement(required = true, type = RCMRMT030101UK05Component4.class)
    protected List<RCMRMT030101UKComponent4> component;

    @XmlElement(type = RCMRMT030101UK05ReplacementOf2.class)
