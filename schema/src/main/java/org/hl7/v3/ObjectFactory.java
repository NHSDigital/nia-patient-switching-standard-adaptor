...
public class ObjectFactory {
    ...
    private final static QName _EFFECTIVE_TIME_QNAME = new QName("urn:hl7-org:v3", "effectiveTime");
    ...
    @XmlElementDecl(namespace = "", name = "effectiveTime")
    public JAXBElement<IVLTS> createEffectiveTime(IVLTS value) {
        return new JAXBElement<IVLTS>(_EFFECTIVE_TIME_QNAME, IVLTS.class, null, value);
    }
}
