...
@XmlType(name = "RCMR_MT030101UK05.ResponsibleParty", propOrder = {
    "agentDirectory"
})
public class RCMRMT030101UK05ResponsibleParty implements RCMRMT030101UKResponsibleParty {

    @XmlElement(required = true, type = RCMRMT030101UK05AgentDirectory.class)
