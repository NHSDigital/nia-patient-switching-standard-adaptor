...
@XmlType(name = "RCMR_MT030101UK05.ObservationStatement", propOrder = {
    "id",
    "code",
    "statusCode",
    "effectiveTime",
...
public class RCMRMT030101UK05ObservationStatement implements RCMRMT030101UKObservationStatement {
    ...
    @XmlElement(type = RCMRMT030101UK05Subject.class)
    protected RCMRMT030101UKSubject subject;

    @XmlElement(type = RCMRMT030101UK05Specimen.class)
    protected List<RCMRMT030101UKSpecimen> specimen;

    @XmlElement(type = RCMRMT030101UK05PertinentInformation02.class)
    protected List<RCMRMT030101UKPertinentInformation02> pertinentInformation;

    @XmlElement(type = RCMRMT030101UK05ReferenceRange.class)
