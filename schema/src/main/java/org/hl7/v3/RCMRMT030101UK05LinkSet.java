...
@XmlType(name = "RCMR_MT030101UK05.LinkSet", propOrder = {
    "id",
    "code",
    "statusCode",
    "effectiveTime",
...
public class RCMRMT030101UK05LinkSet implements RCMRMT030101UKLinkSet {
    ...
    @XmlElement(type = RCMRMT030101UK05Component6.class)
    protected List<RCMRMT030101UKComponent6> component;

    @XmlElement(type = RCMRMT030101UK05ConditionNamed.class)
