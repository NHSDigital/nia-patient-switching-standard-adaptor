 ...
 *         &amp;lt;element name="author" type="{urn:hl7-org:v3}RCMR_MT030101UK05.Author2"/&amp;gt;
...
@XmlType(name = "RCMR_MT030101UK05.EhrFolder", propOrder = {
    "id",
    "statusCode",
    "effectiveTime",
    "availabilityTime",
...
public class RCMRMT030101UK05EhrFolder implements RCMRMT030101UKEhrFolder {
    ...
    @XmlElement(required = true, type = RCMRMT030101UK05Author2.class)
    protected RCMRMT030101UKAuthor2 author;

    @XmlElement(required = true, type = RCMRMT030101UK05ResponsibleParty.class)
    protected RCMRMT030101UKResponsibleParty responsibleParty;

    @XmlElement(required = true, type = RCMRMT030101UK05Component3.class)
