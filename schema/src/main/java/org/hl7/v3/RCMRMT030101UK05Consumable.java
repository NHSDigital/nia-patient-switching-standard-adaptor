...
@XmlType(name = "RCMR_MT030101UK05.Consumable", propOrder = {
    "manufacturedProduct"
})
public class RCMRMT030101UK05Consumable implements RCMRMT030101UKConsumable {

    @XmlElement(required = true, type = RCMRMT030101UK05ManufacturedProduct.class)
