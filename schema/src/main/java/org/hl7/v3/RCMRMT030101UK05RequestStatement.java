...
@XmlType(name = "RCMR_MT030101UK05.RequestStatement", propOrder = {
    "id",
    "code",
    "text",
    "statusCode",
...
public class RCMRMT030101UK05RequestStatement implements RCMRMT030101UKRequestStatement {
    ...
    @XmlElement(type = RCMRMT030101UK05ResponsibleParty3.class)
