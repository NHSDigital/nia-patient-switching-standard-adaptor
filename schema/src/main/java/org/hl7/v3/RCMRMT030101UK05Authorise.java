...
@XmlType(name = "RCMR_MT030101UK05.Authorise", propOrder = {
    "id",
    "code",
    "statusCode",
    "effectiveTime",
...
public class RCMRMT030101UK05Authorise implements RCMRMT030101UKAuthorise {
    ...
    @XmlElement(type = RCMRMT030101UK05Predecessor.class)
