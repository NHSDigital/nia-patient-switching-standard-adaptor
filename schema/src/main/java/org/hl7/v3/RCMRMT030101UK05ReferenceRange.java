...
@XmlType(name = "RCMR_MT030101UK05.ReferenceRange", propOrder = {
    "referenceInterpretationRange"
})
public class RCMRMT030101UK05ReferenceRange implements RCMRMT030101UKReferenceRange {

    @XmlElement(required = true, type = RCMRMT030101UK05InterpretationRange.class)
