...
@XmlType(name = "RCMR_MT030101UK05.Subject", propOrder = {
    "personalRelationship"
})
public class RCMRMT030101UK05Subject implements RCMRMT030101UKSubject {

    @XmlElement(required = true, type = RCMRMT030101UK05PersonalRelationship.class)
