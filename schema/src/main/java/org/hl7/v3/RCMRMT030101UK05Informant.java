...
@XmlType(name = "RCMR_MT030101UK05.Informant", propOrder = {
    "informantRole"
})
public class RCMRMT030101UK05Informant implements RCMRMT030101UKInformant {

    @XmlElement(required = true, type = RCMRMT030101UK05InformantRole.class)
