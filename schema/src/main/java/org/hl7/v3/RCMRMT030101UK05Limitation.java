...
@XmlType(name = "RCMR_MT030101UK05.Limitation", propOrder = {
    "limitingEhrExtractSpecification"
})
public class RCMRMT030101UK05Limitation implements RCMRMT030101UKLimitation {

    @XmlElement(required = true, type = RCMRMT030101UK05EhrExtractSpecification.class)
