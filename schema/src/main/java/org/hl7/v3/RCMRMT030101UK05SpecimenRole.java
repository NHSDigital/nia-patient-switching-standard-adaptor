...
@XmlType(name = "RCMR_MT030101UK05.SpecimenRole", propOrder = {
    "id",
    "effectiveTime",
    "specimenSpecimenMaterial"
})
public class RCMRMT030101UK05SpecimenRole implements RCMRMT030101UKSpecimenRole {

    @XmlElement(required = true)
    protected List<II> id;
    protected IVLTS effectiveTime;

    @XmlElement(required = true, type = RCMRMT030101UK05SpecimenMaterial.class)
