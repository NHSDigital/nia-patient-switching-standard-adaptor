...
@XmlType(name = "RCMR_MT030101UK05.AgentDirectory", propOrder = {
    "part"
})
public class RCMRMT030101UK05AgentDirectory implements RCMRMT030101UKAgentDirectory {

    @XmlElement(type = RCMRMT030101UK05Part.class)
