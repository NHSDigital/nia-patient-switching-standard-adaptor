...
@XmlType(name = "RCMR_MT030101UK05.Dispense", propOrder = {
    "id",
    "code",
    "statusCode",
    "availabilityTime",
...
public class RCMRMT030101UK05Dispense implements RCMRMT030101UKDispense {
    ...
    @XmlElement(type = RCMRMT030101UK05InFulfillmentOf.class)
