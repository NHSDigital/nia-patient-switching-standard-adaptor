...
@XmlType(name = "RCMR_MT030101UK05.EhrExtractSpecification", propOrder = {
    "id",
    "code",
    "effectiveTime"
})
public class RCMRMT030101UK05EhrExtractSpecification implements RCMRMT030101UKEhrExtractSpecification {
