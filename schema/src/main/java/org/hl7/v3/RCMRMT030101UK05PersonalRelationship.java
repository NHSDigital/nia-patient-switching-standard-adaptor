...
@XmlType(name = "RCMR_MT030101UK05.PersonalRelationship", propOrder = {
    "code",
    "relationshipHolder"
})
public class RCMRMT030101UK05PersonalRelationship implements RCMRMT030101UKPersonalRelationship {

    protected CE code;

    @XmlElement(type = RCMRMT030101UK05Person.class)
